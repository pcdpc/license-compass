...
import { CheckCircle2, Circle, Plus, ListTodo, Calendar } from 'lucide-react';
      ...
      {tasks.length === 0 && !isAdding ? (
        ...
        <ul className="space-y-2 mb-4">
          {displayedTasks.map(task => (
            <li key={task.id} className="flex items-start gap-3 p-2 hover:bg-white/5 rounded-lg transition-colors group">
              <button 
