      ...
      <div className="flex-1 flex items-center justify-center p-12 bg-transparent relative overflow-hidden">
        <div className="w-full max-w-sm space-y-8 glass-panel p-10 rounded-3xl relative z-10 border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
          ...
          <button
            ...
            className="w-full flex justify-center items-center py-3.5 px-4 rounded-xl bg-white/10 border border-white/20 hover:bg-white/20 hover:border-white/30 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] focus:outline-none hover:-translate-y-[2px] transition-all duration-300 font-bold text-white group disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
          >
            {isSigningIn ? (
