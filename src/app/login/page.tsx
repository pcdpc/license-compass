...
export default function LoginPage() {
  ...
  return (
    <main className="relative bg-[#050505] min-h-screen overflow-x-hidden">
      ...
      <div className="flex flex-[1.2] flex-col justify-center p-8 lg:p-12 bg-white/5 backdrop-blur-md text-zinc-100 border-b lg:border-b-0 lg:border-r border-white/10 relative overflow-hidden">
        <div className="max-w-md mx-auto relative z-10 pt-12 lg:pt-0">
          ...
          <h2 className="text-5xl font-extrabold mb-8 leading-tight text-white drop-shadow-md">
            Manage Your NP Licenses <span className="text-indigo-400">From Anywhere</span>
          </h2>
          <p className="text-xl text-zinc-400 mb-2 font-medium leading-relaxed">
            Track licenses, renewals, CE requirements, expiration dates, and multi-state applications in one organized dashboard.
          </p>
            ...
            >
              ...
              {authMode === 'login' && (
                <div className="flex flex-col items-center mt-1">
                  <span className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest">Start your free 14-day trial</span>
                  <span className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest">No credit card required. Cancel anytime.</span>
                </div>
              )}
            </button>
          </div>
